...
- 作者文案入口统一到页面配置；分类/系列 ID 从资料自动派生，额外资源收录单独配置。见 [编辑入口](../src/config/README.md)。
- 全站静态 Open Graph/Twitter 分享信息与 canonical；固定默认分享头像，文章封面优先，并附带文章日期。目标聊天平台效果待发布后验证，详见 [分享记录](link-sharing-2026-09-06.md)。
