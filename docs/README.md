...
- [2026-09-06 提交前审核](review-2026-09-06.md)：审核结论、非阻断问题与验证边界。
- [2026-09-06 配置入口整理](config-entrypoints-2026-09-06.md)：文案归位、单一 ID 来源与配置保护。
- [2026-09-06 链接分享元信息](link-sharing-2026-09-06.md)：静态分享图、文章元信息及聊天平台缓存边界。

- [2026-09-05 标签页、搜索与组图操作](tab-search-gallery-2026-09-05.md)：角色 favicon、多语言祝福、本地全文搜索和图片两侧滚轮导航。

- [2026-09-05 加载与阅读稳定性](loading-stability-2026-09-05.md)：稀疏筛选间距、图片/评论跳动、独立 cover 上云与实测收益。

- [2026-09-05 开发记录](development-record-2026-09-05.md)：阅读、交互、评论、系列、资源更新。
- [2026-09-05 画廊迭代](resource-gallery-2026-09-05.md)：设计依据、修复根因与验收。
